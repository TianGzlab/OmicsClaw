...
author: OmicsClaw
license: MIT
tags: [spatial, domains, niche, tissue-region, clustering, leiden, louvain, spagcn,
  stagate, graphst, banksy, cellcharter]
metadata:
  omicsclaw:
    domain: spatial
    allowed_extra_flags:
    ...
    param_hints:
      ...
      stagate:
        ...
        requires: ["obsm.spatial"]
        tips:
        - "--rad-cutoff / --k-nn: Spatial network. Varies by platform (Visium~150,
          Slide-seq~50)."
