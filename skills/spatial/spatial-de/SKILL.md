  ...
  omicsclaw:
    ...
    param_hints:
      ...
      t_test:
        ...
        requires: ["X_log_normalized"]
      pydeseq2:
        priority: "groupby → group1/group2"
        params: ["groupby", "group1", "group2", "n_top_genes"]
        defaults: {groupby: "leiden", n_top_genes: 10}
        requires: ["counts_or_raw", "sample_annotations_for_pseudobulk"]
    legacy_aliases: [de]
    saves_h5ad: true
...
- **Why OmicsClaw**: Standardised DE ensures consistent methodology, structured outputs, and wrapper-generated guides across spatial analysis pipelines
