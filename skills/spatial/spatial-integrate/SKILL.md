  ...
  omicsclaw:
    ...
    param_hints:
      harmony:
        ...
        tips:
        - "--harmony-theta: Diversity penalty; raise it to encourage stronger batch
          mixing."
      ...
      bbknn:
        ...
        defaults: {batch_key: "batch", bbknn_neighbors_within_batch: 3, bbknn_n_pcs: 50,
          bbknn_trim: null}
        requires: ["obsm.X_pca", "obs.batch_key"]
        tips:
      ...
      scanorama:
        ...
        params: ["batch_key", "scanorama_knn", "scanorama_sigma", "scanorama_alpha",
          "scanorama_batch_size"]
        defaults: {batch_key: "batch", scanorama_knn: 20, scanorama_sigma: 15.0, scanorama_alpha: 0.1,
