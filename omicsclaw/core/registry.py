...
_HARDCODED_SKILLS: dict[str, dict[str, Any]] = {
    ...
    "sc-tenifold-knockout": {
        "domain": "singlecell",
        "alias": "sc-tenifold-knockout",
        "script": SKILLS_DIR / "singlecell" / "scrna" / "sc-tenifold-knockout" / "sc_tenifold_knockout.py",
        "demo_args": ["--demo"],
        "description": "Virtual knockout analysis from WT scRNA-seq using scTenifoldKnk",
