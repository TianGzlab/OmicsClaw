...
It now delegates to the new :mod:`omicsclaw.spatial.viz` package.

Existing code importing from this module continues to work unchanged::

    from omicsclaw.spatial.viz_utils import save_figure, non_interactive_backend

New code should import from the richer package instead::

    from omicsclaw.spatial.viz import plot_features, VizParams
"""
...
from omicsclaw.spatial.viz import (  # noqa: E402, F401
    VizParams,
    plot_cnv,
    plot_communication,
    plot_deconvolution,
