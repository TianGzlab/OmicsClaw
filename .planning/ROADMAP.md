...
**Plans**: 2 plans
Plans:
- [ ] 20-01-PLAN.md — enrichment.R network/enrichmap + de.R manhattan + registry + Python wiring (SCOP-05, SCOP-06)
- [ ] 20-02-PLAN.md — pseudotime.R multi-lineage DynamicPlot + communication.R bipartite/diff + registry + Python wiring (SCOP-07)
...
| 20. scop 绘图搬运 — 增强现有 Renderer | v2.0 | 0/2 | Not Started |  |
